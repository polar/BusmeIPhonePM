class UIBanner < UIView
  ...
  def viewDidLoad
    ...
    if bannerInfo.goUrl && !bannerInfo.goUrl.empty?
      on_tap do
  ...
  def initWith(bannerInfo, masterMapScreen)
    ...
    self.textView.text = bannerInfo.description || bannerInfo.title
